...
public class RabbitConsumerTopologyConfig {
    ...
    @Bean
    public Declarables proposalAcceptedJobTopology() {
        return consumerTopology("proposal.events", "proposal.accepted", "proposal.accepted.job");
    }

    @Bean
    public Declarables proposalCompletedJobTopology() {
        return consumerTopology("proposal.events", "proposal.completed", "proposal.completed.job");
    }

    @Bean
    public Declarables proposalCancelledJobTopology() {
        return consumerTopology("proposal.events", "proposal.cancelled", "proposal.cancelled.job");
    }

    @Bean
    public Declarables proposalWithdrawnJobTopology() {
        return consumerTopology("proposal.events", "proposal.withdrawn", "proposal.withdrawn.job");
    }
